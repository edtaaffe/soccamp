jQuery(document).ready(function () {
    ...
    var posts = {'ipage': 1};
    jQuery('.bots-page .save-bookmark').click(function(e) {
        e.preventDefault();
        ...
        jQuery.ajax({
            url: url + 'user/app-ajax/bots?action=bookmark&bookmark=' + cleanURL,
            dataType: 'json',
            type: 'GET',
    ...
    $('.container-fluid .setopt').click(function () {
        jQuery.ajax({
            url: url + 'user/app-ajax/tools?action=enable_disable_option&option=' + $(this).attr('id'),
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data.success) {
                    ...
                    Main.popup_fon('sube', words.mu59, 1500, 2000);
                }
            },
            error: function (data, jqXHR, textStatus) {
                console.log('Request failed: ' + textStatus);
