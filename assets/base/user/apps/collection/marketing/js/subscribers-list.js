/*
 * Marketing Subscribers List javascript file
*/
...
jQuery(document).ready(function ($) {
    ...
    ********************************/
    ...
    Main.load_subscribers = function (page) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'POST', data, 'load_subscribers');
    ...
    ********************************/
    ...
    Main.methods.load_subscribers = function (status, data) {
        ...
        // Hide pagination
        $('.main .marketing-user-list .pagination').hide();

        // Verify if the success response exists
        if (status === 'success') {

            // Show pagination
            $('.main .marketing-user-list .pagination').fadeIn('slow');

            // Display the pagination
            Main.pagination.page = data.page;
            Main.show_pagination('.main .marketing-user-list', data.total);
                ...
                subscribers += '<li>'
                                + '<div class="row">'
                                    ...
                                    + '<div class="col-xl-4 col-6 text-right">'
                                        + '<a href="' + url + 'user/app/marketing?p=subscribers&subscriber=' + data.subscribers[c].subscriber_id + '" class="btn btn-outline-info inbox-account-details">'
            ...
            // Display subscribers
            $('.main .marketing-user-list .subscribers-list').html(subscribers);
            ...
            $('.main .marketing-user-list .subscribers-list').html(message);
