/*
 * Marketing Suggestions List javascript file
*/
...
jQuery(document).ready(function ($) {
    ...
    ********************************/
    ...
    $(document).on('click', '.main .delete-group', function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'GET', data, 'delete_group');
        ...
        if (status === 'success') {
            ...
            for (var c = 0; c < data.groups.length; c++) {
                ...
                groups += '<li>'
                            + '<div class="row">'
                                + '<div class="col-11">'
                                    + '<a href="' + url + 'user/app/marketing?p=suggestions&group=' + data.groups[c].group_id + '" class="show-group">'
