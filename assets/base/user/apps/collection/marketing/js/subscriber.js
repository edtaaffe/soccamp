/*
 * Marketing Subscriber javascript file
*/
...
jQuery(document).ready(function ($) {
    ...
    ********************************/
    ...
    Main.get_all_subscriber_categories = function () {
        ...
        var data = {
            ...
            subscriber_id: $('.main .marketing-page').attr('data-subscriber')
        };
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'POST', data, 'get_all_subscriber_categories');
    ...
    Main.get_all_messages = function (page) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'POST', data, 'get_all_messages');
    ...
    ********************************/
    ...
    $(document).on('click', '.main .all-categories-list .select-category', function () {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'POST', data, 'select_subscriber_category');
    ...
    $(document).on('click', '.main .settings-save-changes .btn', function (e) {
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'POST', data, 'save_subscriber_categories');
