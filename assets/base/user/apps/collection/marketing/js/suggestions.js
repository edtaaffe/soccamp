/*
 * marketing Suggestions javascript file
*/
...
jQuery(document).ready(function ($) {
    ...
    ********************************/
    ...
    Main.load_suggestions = function () {
        ...
        var data = {
            ...
            group_id: $('.main .marketing-page-suggestions').attr('data-group')
        };

        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'GET', data, 'display_suggestions');
            ...
            switch ( suggestions.length ) {
                ...
                case 3:
                    ...
                    if (($('.main .new-suggestions-top').width() < 1219) && $('.main .new-suggestions-top').width() > 1002) {
                        ...
                        // Set the position of the second suggestions list
                        $('.main .suggestions-body-area').css({
                            'height': (first_column + $('.main .first-4').outerHeight() + 400) + 'px'
                        });

                    } else if ($('.main .new-suggestions-top').width() < 1219) {
    ...
    Main.methods.save_suggestions = function (status, data) {
        ...
        if (status === 'success') {
            ...
            setTimeout(function(){
                ...
                if ( !$('.main .marketing-page-suggestions').attr('data-group') ) {

                    // Redirect to the group's page
                    document.location.href = url + 'user/app/marketing?p=suggestions&group=' + data.group_id;
    ...
    ********************************/
    ...
    $(document).on('submit', '.main .save-suggestions-form', function (e) {
        ...
        // If group's id exists
        if ( $('.main .marketing-page-suggestions').attr('data-group') ) {
            data['group_id'] = $('.main .marketing-page-suggestions').attr('data-group');
        }
        ...
        // Make ajax call
        Main.ajax_call(url + 'user/app-ajax/marketing', 'POST', data, 'save_suggestions');
     ...
     * @since   0.0.8.0
     */
    $(document).on('submit', '.main .marketing-save-template', function (e) {
        e.preventDefault();
