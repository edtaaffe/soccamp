jQuery(document).ready( function ($) {
    ...
    $('.add-repeat').click(function(){
        ...
        var plan = '<div class="list-group-item"><div class="row"><div class="col-xl-2"><select class="days"><option value="1">' + words.mu193 + '</option><option value="2">' + words.mu194 + '</option><option value="3">' + words.mu195 + '</option><option value="4">' + words.mu196 + '</option><option value="5">' + words.mu197 + '</option><option value="6">' + words.mu198 + '</option><option value="7">' + words.mu199 + '</option></select></div><div class="col-xl-3 clean"><select class="plan-time"><option value="00:00">00:00</option><option value="01:00">01:00</option><option value="02:00">02:00</option><option value="03:00">03:00</option><option value="04:00">04:00</option><option value="05:00">05:00</option><option value="06:00">06:00</option><option value="07:00">07:00</option><option value="08:00">08:00</option><option value="09:00">09:00</option><option value="10:00">10:00</option><option value="11:00">11:00</option><option value="12:00">12:00</option><option value="13:00">13:00</option><option value="14:00">14:00</option><option value="15:00">15:00</option><option value="16:00">16:00</option><option value="17:00">17:00</option><option value="18:00">18:00</option><option value="19:00">19:00</option><option value="20:00">20:00</option><option value="21:00">21:00</option><option value="22:00">22:00</option><option value="23:00">23:00</option></select></div><div class="col-xl-3 "><select class="when"><option value="1">' + words.mu200 + '</option><option value="2">' + words.mu201 + '</option><option value="3">' + words.mu202 + '</option><option value="4">' + words.mu203 + '</option></select></div><div class="col-xl-2 clean"><select class="repeat"><option value="1">1 ' + words.mu204 + '</option><option value="2">2 ' + words.mu205 + '</option><option value="3">3 ' + words.mu205 + '</option><option value="4">4 ' + words.mu205 + '</option><option value="5">5 ' + words.mu205 + '</option><option value="6">6 ' + words.mu205 + '</option><option value="7">7 ' + words.mu205 + '</option><option value="8">8 ' + words.mu205 + '</option><option value="9">9 ' + words.mu205 + '</option><option value="10">10 ' + words.mu205 + '</option><option value="11">11 ' + words.mu205 + '</option><option value="12">12 ' + words.mu205 + '</option><option value="13">13 ' + words.mu205 + '</option><option value="14">14 ' + words.mu205 + '</option><option value="15">15 ' + words.mu205 + '</option><option value="16">16 ' + words.mu205 + '</option><option value="17">17 ' + words.mu205 + '</option><option value="18">18 ' + words.mu205 + '</option><option value="19">19 ' + words.mu205 + '</option><option value="20">20 ' + words.mu205 + '</option><option value="21">21 ' + words.mu205 + '</option><option value="22">22 ' + words.mu205 + '</option><option value="23">23 ' + words.mu205 + '</option><option value="24">24 ' + words.mu205 + '</option><option value="25">25 ' + words.mu205 + '</option><option value="26">26 ' + words.mu205 + '</option><option value="27">27 ' + words.mu205 + '</option><option value="28">28 ' + words.mu205 + '</option><option value="29">29 ' + words.mu205 + '</option><option value="30">30 ' + words.mu205 + '</option></select></div><div class="col-xl-2 text-right"><a href="#" class="delete-planner-rule">' + words.mm133 + '</a></div></div></div>';
    ...
    $(document).on('click', '.delete-planner-rule', function (e) {
        ...
        if ( $('.post-plans>div>.list-group-item').length < 1 ){
            $('.post-plans>div').html('<p>' + words.mm190 + '</p>');
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.search('msuccess') > 0) {
                    ...
                    Main.popup_fon('sube', words.mm3, 1500, 2000);
                }
            },
    ...
    $('.schedule-campaign').submit(function(e){
        ...
        if(emails.publish > 0) {
            if(lists.list_id === 0) {
                Main.popup_fon('sube', words.mu285, 1500, 2000);
                return;
            }
        }
        if(!date) {
        ...
        if(!template_title) {
            Main.popup_fon('sube', words.mu286, 1500, 2000);
            return;
        }        
        if(!first_template) {
            Main.popup_fon('sube', words.mu146, 1500, 2000);
            return;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.search('msuccess') > 0) {
                    ...
                    $('.emails-page .select-list.active').text(words.mu42);
    ...
    $(document).on('click', '.emails-page .besan', function (e) {
        ...
        var data = {
            action: 'query',
            smtp_option: 'smtp_options',
            field: field,
            value: val,
            campaign_id: $('.campaign-page').attr('data-id')
        };
        ...
        $.ajax({
            ...
            data: data,
            success: function (data) {
                Main.popup_fon('subi', words.mm2, 1500, 2000);
            },
            error: function (data, jqXHR, textStatus) {
                console.log(data);
                Main.popup_fon('sube', words.mm3, 1500, 2000);
    ...
    $(document).on('click', '.delete-cam', function (e) {
        ...
        $.ajax({
            url: url + 'user/app-ajax/emails?action=dcampaign&campaign=' + uri,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if (data == 1) {
                    Main.popup_fon('subi', words.mm147, 1500, 2000);
                    if(te === 0) {
                        setTimeout(function(){document.location.href = url+'user/app/emails';},2000);
                    } else {
                        campaigns_results(1);
                    }
                } else {
                    Main.popup_fon('sube', words.mm148, 1500, 2000);
                }
            },
            error: function (data, jqXHR, textStatus) {
                console.log('Request failed: ' + textStatus);
    ...
    $(document).on('click','.delete-email',function(e) {
        ...
        // create an object with form data
        $.ajax({
            url: url + 'user/app-ajax/emails?action=dmeta&meta=' + meta + '&list='+list,
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                ...
                if(data == 1){
                    ...
                    Main.popup_fon('sube', words.mm149, 1500, 2000);
                }
                if(table.find('tr').length < 1) {
                    table.find('.list-emails').html('<tr><td>'+words.mm150+'</td></tr>');
                }
            },
            error: function (data, jqXHR, textStatus) {
                console.log(data);
                Main.popup_fon('sube', words.mm151, 1500, 2000);
            },
        });
    });
    $(document).on('click', '.delete-list', function (e) {
        ...
        $.ajax({
            url: url + 'user/app-ajax/emails?action=delete_list&list=' + uri,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if (data == 1) {
                    Main.popup_fon('subi', words.mm152, 1500, 2000);
                    if(te === 0) {
                        setTimeout(function(){document.location.href = url+'user/app/emails';},2000);
                    } else {
                        lists_results(1);
                    ...
                    Main.popup_fon('sube', words.mm153, 1500, 2000);
                }
            },
            error: function (data, jqXHR, textStatus) {
                console.log(data);
    ...
    $(document).on('click', '.emails-page .deleteTemplate', function () {
        ...
        var $this = $(this);
        $.ajax({
            url: url + 'user/app-ajax/emails?action=dtemplate&template=' + templateId,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data === 1){
                    $this.closest('li').remove();
                    Main.popup_fon('subi', words.mm193, 1500, 2000);
                    if($('.deleteTemplate').length < 1) {   
                        $('.show-templates-lists-here>ul').html('<p class="no-results-found">' + words.mm154 + '</p>');
                    }
                } else {
                    Main.popup_fon('sube', words.mm194, 1500, 2000);
                }
            },
            error: function (data, jqXHR, textStatus) {
                Main.popup_fon('sube', words.mm194, 1500, 2000);
    ...
    $(document).on('click', '.emails-page .select-temp', function () {
        ...
        var $this = $(this);
        $.ajax({
            url: url + 'user/app-ajax/emails?action=stemplate&template=' + templateId,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data) {
    ...
    $('.load-csv').on('change',function(){
        if($('.load-csv').val()) {
            $('.alert-msg').html('<p class="msuccess block">'+words.mm155+'</p>');
        }
    });
    ...
    $(document).on('click', '.get-csv-sent', function (e) {
        ...
        window.open(url + 'user/app-ajax/emails?action=schedules&type=' + type + '&scheduled=' + sched_id + '&page=1&export=1');
    });    
    $(document).on('click', '.delete-schedules', function (e) {
        ...
        var $this = $(this);
        $.ajax({
            url: url + 'user/app-ajax/emails?action=dsched&scheduled=' + scheduledId,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                Main.popup_fon('subi', words.scheduled_template_deleted_successfully, 1500, 2000);
                shistory(1);
            },
            error: function (data, jqXHR, textStatus) {
                console.log('Request failed: ' + textStatus);
    ...
    function campaigns_results(page) {
        ...
        $.ajax({
            url: url + 'user/app-ajax/emails?action=show_campaigns&page=' + page,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                ...
                if(data.total) {
                                    ...
                                    + '<div class="row">'
                                        ...
                                        + '<div class="col-xl-2">'
                                            + '<div class="btn-group pull-right">'
                                                + '<a href="' + url + 'user/app/emails?p=campaign&campaign=' + campaign_id + '" class="btn btn-default"><i class="icon-login"></i> ' + words.mm136 + '</a>'
                    ...
                    $( 'ul.midrub-emails-campaigns' ).html('<p class="no-results-found">' + words.mm179 + '</p>');
                }
    ...
    function show_template_lists() {
        ...
        $.ajax({
            url: url + 'user/app-ajax/emails?action=get_templates&campaign=' + campaign_id,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
    ...
    function schedules() {
        ...
        var campaign_id = $('.campaign-page').attr('data-id');
        $.ajax({
            url: url + 'user/app-ajax/emails?action=schedules&campaign=' + campaign_id,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data.length) {
                    ...
                    for(var m = 0; m < data.length; m++) {
                        ...
                        if(typeof tot === 'undefined') {
                            tot = '<li><div class="col-xl-10 col-sm-8 col-xs-6 "><h3>'+words.mm156+data[m].title+words.mm157+data[m].name+'</h3><span>'+gettime+'</span></div><div class="col-xl-2 col-sm-4 col-xs-6  text-right"><button type="button" class="btn btn-danger delete-schedules" data-id="'+data[m].scheduled_id+'"><i class="icon-trash"></i> '+words.mm133+'</button></div></li>';
                        } else {
                            tot += '<li><div class="col-xl-10 col-sm-8 col-xs-6 "><h3>'+words.mm156+data[m].title+words.mm157+data[m].name+'</h3><span>'+gettime+'</span></div><div class="col-xl-2 col-sm-4 col-xs-6  text-right"><button type="button" class="btn btn-danger delete-schedules" data-id="'+data[m].scheduled_id+'"><i class="icon-trash"></i> '+words.mm133+'</button></div></li>';
                        }                
                    }
    ...
    function shistory(page) {
        ...
        var campaign_id = $('.campaign-page').attr('data-id');
        $.ajax({
            url: url + 'user/app-ajax/emails?action=shistory&campaign=' + campaign_id + '&page=' + page,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data) {
                    ...
                    if(data.scheds.length) {
                        ...
                        for(var m = 0; m < data.scheds.length; m++) {
                            ...
                            if(data.scheds[m].a < 1) {
                                var bi = '<p><a href="#" class="delete-schedules" data-id="' + data.scheds[m].scheduled_id + '"><span class="badge badge-info badge-danger"><i class="icon-trash"></i> ' + words.mm133 + '</span></a></p>';
                            } else {
                                var bi = '<p><a href="' + url + 'user/app/emails?p=sent&scheduled=' + data.scheds[m].scheduled_id + '"><span class="badge badge-info">'+data.scheds[m].sent+' '+words.mm160+'</span></a><a href="' + url + 'user/app/emails?p=opened&scheduled=' + data.scheds[m].scheduled_id + '"""><span class="badge badge-info badge-opened">'+data.scheds[m].readi+' '+words.mm159+'</span></a><a href="' + url + 'user/app/emails?p=unread&scheduled=' + data.scheds[m].scheduled_id + '"><span class="badge badge-info badge-non">'+data.scheds[m].unread+' '+words.mm161+'</span></a><a href="' + url + 'user/app/emails?p=unsubscribed&scheduled=' + data.scheds[m].scheduled_id + '"><span class="badge badge-info badge-danger">'+data.scheds[m].unsub+' '+words.mm162+'</span></a></p>';
                            }
                            var si = '<li><h4>'+words.mm156+data.scheds[m].title+words.mm158+data.scheds[m].name+' <span class="pull-right">'+gettime+'</span></h4>' + bi + '</li>';
                            if(typeof tot === 'undefined') {
                                tot = si;
                            } else {
                                tot += si;
                        ...
                        $('#nav-history .histories').html('<li><p>'+words.mm163+'</p></li>');
                    }
                } else {
                    $('#nav-history .histories').html('<li><p>'+words.mm163+'</p></li>');
                }
    ...
    function sehistory(page) {
        ...
        var type = $('.sent-info').attr('data-type');
        $.ajax({
            url: url + 'user/app-ajax/emails?action=schedules&type=' + type + '&scheduled=' + sched_id + '&page=' + page,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data.total) {
                    ...
                    $('#sent-emails .list-emails').html('<tr><td>'+words.mm164+'</td></tr>');
                    $('.get-csv-sent').remove();
                }
            },
            error: function (data, jqXHR, textStatus) {
    ...
    function lists_results(page) {
        ...
        $.ajax({
            url: url + 'user/app-ajax/emails?action=show_lists&page=' + page,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data.total) {
                        ...
                        if ( typeof tot === 'undefined' ) {
                            ...
                            tot = '<li>'
                                    + '<div class="row">'
                                        ...
                                        + '<div class="col-xl-2">'
                                            + '<div class="btn-group pull-right">'
                                                + '<a href="' + url+'user/app/emails?p=lists&list=' + list_id + '" class="btn btn-default"><i class="icon-login"></i> ' + words.mm136 + '</a>'
                    ...
                    $( 'ul.midrub-emails-lists' ).html('<p class="no-results-found">' + words.mm180 + '</p>');
    ...
    function emails_results(page) {
        ...
        $.ajax({
            url: url + 'user/app-ajax/emails?action=show_lists_meta&page='+page+'&list='+list,
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                ...
                if(data.total) {
                    ...
                    $('#nav-show-emails .list-emails').html('<tr><td>'+words.mm164+'</td></tr>');
                }
            },
            error: function (data, jqXHR, textStatus)
            {
    ...
    function unactive_emails_results(page) {
        ...
        var list  = $('.list-details').attr('data-id');
        $.ajax({
            url: url + 'user/app-ajax/emails?action=show_lists_meta&page=' + page + '&list=' + list + '&inactive=1',
            dataType: 'json',
            type: 'GET',
            success: function (data) {
                if(data.total) {
                    ...
                    $('#nav-unactive-emails .list-emails').html('<tr><td>'+words.mm164+'</td></tr>');
                }
            },
            error: function (data, jqXHR, textStatus)
            {
    ...
    function gets_stats_for(template_id,time) {
        ...
        var data = {
            action: 'query',
            campaign_statistics: campaign_id,
            template_id: template_id,
            time: time
        };
    ...
    ********************************/
    ...
    $(document).on('click', '.multimedia-gallery-quick-schedule li a', function (e) {
        ...
        if ( $( this ).attr('data-type') === 'video' ) {
            ...
            Main.popup_fon('sube', words.videos_arent_supported, 1500, 2000);
            return;
